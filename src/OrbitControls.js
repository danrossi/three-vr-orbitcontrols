...
THREE.OrbitControls = function ( object, domElement, controlsElement ) {
	...
	this.disconnect = function() {
		...
		if (scope.controlsElement) {
			scope.controlsElement.removeEventListener( 'mousedown', onMouseDown, false );
			scope.controlsElement.removeEventListener( 'touchstart', onTouchStart, false );
		}
	...
	function onMouseDown( event ) {
		...
		scope.dampingFactor = scope.mouseDampingFactor;
